...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Jeitinho — Le blog francophone sur Rio de Janeiro" },
      ...
      { name: "twitter:description", content: "Conseils, histoires, interviews et carnet d'adresses sur Rio de Janeiro. Écrit par des locaux passionnés." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/P49BNSJXTgReHSSiVmU5EKy19QM2/social-images/social-1783703089998-jeitinho-logo.webp" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/P49BNSJXTgReHSSiVmU5EKy19QM2/social-images/social-1783703089998-jeitinho-logo.webp" },
    ],
    links: [
