...
export const article: Article = {
  ...
  popular: true,
  relatedServices: [
    { label: "Conciergerie Carnaval", href: "https://jeitinho.fr/calendrier/sambodrome", description: "Places Sambodrome, camarotes, logement, transferts — on gère la logistique." },
  ],
  sections: [
