...
export const article: Article = {
  ...
  popular: true,
  relatedServices: [
    { label: "Expérience Maracanã", href: "https://jeitinho.fr/experiences/maracana", description: "Billets, transfert, accompagnement par un supporter local. On sélectionne le meilleur match de la semaine." },
  ],
  sections: [
